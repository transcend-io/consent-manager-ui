...
describe('QuickOptions', () => {
  ...
  test('button ordering is consistent', () => {
    ...
    expect(domLabels).toStrictEqual([
      ...
      quickOptionsMessages.functionalButtonPrimary.defaultMessage,
      quickOptionsMessages.analyticsButtonPrimary.defaultMessage,
  ...
  test('submission affects stored consent (analytics)', () => {
    ...
    if (analyticsButton) fireEvent.click(analyticsButton);
