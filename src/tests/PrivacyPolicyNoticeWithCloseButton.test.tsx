...
describe('PrivacyPolicyNoticeWithCloseButton', () => {
  test('matches snapshot', () => {
    const { snapshot } = render(<PrivacyPolicyNoticeWithCloseButton fontColor="#000" handleSetViewState={() => null} />);
  ...
  test('confirms purposes on submission', () => {
    ...
    const { container } = render(<PrivacyPolicyNoticeWithCloseButton fontColor="#000" handleSetViewState={() => null} />);
